...
/**
 * Plugin Name: elia
 * Plugin URI: https://elia.eus
 * Description: Plugin to translate your website through machine translation. Elhuyar's automatic translator is based on artificial intelligence and neural networks and knows 6 languages. Makes translations between these six languages: Basque, Spanish, French, English, Catalan and Galician. This is a "fork" of the popular WPML multilingual (https://wpml.org/).
 * Author: Elhuyar
 * Author URI: https://elia.eus
 * Version: 1.1
 * Plugin Slug: elia
 *
 * @package witz\Core
...
/*Plugin to translate your website through machine translation. Elhuyar's automatic translator is based on artificial intelligence and neural networks and knows 6 languages. Makes translations between these six languages: Basque, Spanish, French, English, Catalan and Galician. This is a "fork" of the popular WPML multilingual (https://wpml.org/)./
...
*Date: 2019
*Code version: 4.3.6
*Availability: https://wpml.org/
Changes on security, namespace and added support for direct translation.
*****/
